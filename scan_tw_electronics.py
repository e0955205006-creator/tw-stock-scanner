...
def backtest_strategy(df_history, ma_series):
    ...
    win_rate = (
        success_trades / trades_count * 100
...
def find_best_ma(s_data):
    ...
    for ma_len in range(15, 36):
        ...
        ret, win, count, logs = backtest_strategy(
            s_data,
            ma_series
        )
