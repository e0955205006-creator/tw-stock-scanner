    ...
    for i in range(len(subset)):
        ...
        if not in_position:
            ...
            if exit_p is not None:
                ...
                trade_logs.append({
                    'buy_date': buy_date, 'buy_p': round(buy_price_raw, 2),
                    'sell_date': date, 'sell_p': round(exit_p, 2),
...
def main():
    ...
    print(f"符合門檻標的共 {len(valid_tickers)} 檔。開始進行 3 年還原權值深度回測...")
            ...
            if abs(diff) <= 0.01:
                ...
                <div class="card mb-4 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-sm btn-outline-secondary mb-3" type="button" data-bs-toggle="collapse" data-bs-target="#logs_{pure_symbol}">對帳單 ({count} 筆明細)</button>
